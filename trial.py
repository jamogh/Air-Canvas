...
while ret:
    ...
    if result.multi_hand_landmarks:
        ...
        if (thumb[1] - center[1] < 30):
            ...
            if 40 <= center[0] <= 140:  # Clear Button
                ...
                cv2.imwrite("captured_paint.png", paint_image)
                print("Screenshot captured and saved as 'captured_paint.png'.")

                # Prepare the image for the model
                inputs = image_processor(paint_image, return_tensors="pt").to(model.device)
            ...
            if colorIndex == 0:
                ...
                cv2.circle(paintWindow, (center[0], center[1]), 5, colors[colorIndex], cv2.FILLED)
            elif colorIndex == 1:
    ...
    # Combine paint window and frame for display
    frame = cv2.addWeighted(frame, 0.5, paintWindow, 0.5, 0)
